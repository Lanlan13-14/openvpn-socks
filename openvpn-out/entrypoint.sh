...
: "${PROXY_UDP_OVER_TCP:=${PROXY_UDP:-true}}"
: "${PROXY_TLS_SERVER_NAME:=}"
: "${PROXY_TLS_INSECURE:=${PROXY_SKIP_CERT_VERIFY:-0}}"
: "${PROXY_TLS_ALPN:=}"
: "${PROXY_SKIP_CERT_VERIFY:=${PROXY_TLS_INSECURE}}"
...
export OVPN_CIPHER OVPN_DATA_CIPHERS OVPN_AUTH OVPN_TUN_MTU OVPN_MSSFIX OVPN_VERB OVPN_DUPLICATE_CN_CONFIG OVPN_CLIENT_TO_CLIENT_CONFIG OVPN_PRESERVE_TEMPLATE IPV6_ENABLED OVPN_IPV6_CIDR OVPN_IPV6_CONFIG
export PROXY_TYPE PROXY_HOST PROXY_PORT PROXY_USER PROXY_PASS PROXY_PASSWORD PROXY_METHOD PROXY_UDP_OVER_TCP PROXY_TLS_SERVER_NAME PROXY_TLS_INSECURE PROXY_TLS_ALPN PROXY_SKIP_CERT_VERIFY
...
export DNS_SERVER_TYPE DNS_SERVER DNS_SERVER_PORT DNS_PATH DNS_TLS_SERVER_NAME DNS_TLS_INSECURE DNS_TLS_ALPN DNS_STRATEGY PROXY_DOMAIN_RESOLVER DNS_DETOUR DNSMASQ_ENABLED DNSMASQ_PORT DNSMASQ_UPSTREAM DNSMASQ_CACHE_SIZE DNSMASQ_LOG_QUERIES ENABLE_DIAGNOSTICS PROXY_CHECK_URL PROXY_CHECK_IPV6_URL
